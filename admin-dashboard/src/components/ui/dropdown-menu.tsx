...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ref={ref}
    className={cn(
      "z-50 min-w-[8rem] overflow-hidden rounded-md border border-border bg-popover text-popover-foreground shadow-md animate-in data-[state=open]:fade-in data-[state=open]:zoom-in-95",
      className
    )}
    sideOffset={4}
    alignOffset={-4}
