...
import { validateRequestBody, locationUpdateSchema } from "@/lib/api-validation";
...
export async function GET(
  ...
  try {
    ...
    const response = await fetch(`${baseUrl}/api/admin/locations/${id}`, {
...
const putHandler = async (
  ...
  try {
    ...
    const validation = await validateRequestBody(locationUpdateSchema, body);
